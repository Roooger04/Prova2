...
import imagem from '../img/vintage-cars.png';
...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <img alt="Carros antigos" style={{opacity: visible ? '1' : '0', height: visible ? '591px': '0'}} />
            ...
            <img src={imagem} className={classes.figura} alt="Carros Antigos" style={{ opacity: visible ? '1' : '0', height: visible ? '600px' : '0'}}/>
        </>
    )
}